    ...
    return function a(b, c, d) {
        ...
        18: [function(a, b, c) {
            ...
            b.exports = function(a, b, c) {
                return function() {
                    function e(a) {
                        var b = c().accessor(e.accessor()).period(g).init(),
                        ...
                        return g = parseInt(g), a.map(function(c, e) {
                            ...
                            var k = f.accessor.h(a[e]) - f.accessor.h(a[e - 1]),
                                l = f.accessor.l(a[e - 1]) - f.accessor.l(a[e]),
                                m = 0;
                            k > l && k > 0 && (m = k);
                            var n = 0;
                            l > k && l > 0 && (n = l);
                            var o = D3.d3.max([f.accessor.h(c) - f.accessor.l(c), Math.abs(f.accessor.h(c) - f.accessor.c(a[e - 1])), Math.abs(f.accessor.l(c) - f.accessor.c(a[e - 1]))]),
                                p = b.average(m),
                                q = h.average(n),
                                r = i.average(o);
                            if (e > g) {
        ...
        36: [function(a, b, c) {
            ...
            function d(a, b, c, d, g, j, k, l, m) {
                var n = "left" === d.orient() || "top" === d.orient() ? -1 : 1,
                    o = a.select("g.translate"),
                    p = b.groupSelect(o, e(c, d.scale()));
                ...
                return function() {
                    function a(b) {
                        var c = b.selectAll("g.data.top").data([q], function(a) {
                            ...
                            d = c.enter(),
                            e = d.append("g").attr("class", "data top").style("display", "none");
                    ...
                    function b(a, b, d, e) {
                        return function() {
                            var f = c(this),
                                g = m.xScale.invert(f[0]),
                                i = m.yScale.invert(f[1]);
                    ...
                    var k, l, m = {},
                        ...
                        q = 0;
                    return a.refresh = function(a) {
                        var c = m.xScale.range(),
                            e = m.yScale.range(),
                            f = a.selectAll("g.data"),
                            g = a.selectAll("rect"),
                            h = f.selectAll("path.vertical"),
                            i = f.selectAll("path.horizontal"),
                            k = f.selectAll("g.axisannotation.x > g"),
                            l = f.selectAll("g.axisannotation.y > g");
                        g.attr({
                            ...
                            d(a, "none"), n.out()
                        }).on("mousemove", b(h, i, k, l)), j(h, i, k, l)
        ...
        40: [function(a, b, c) {
            ...
            b.exports = function(a, b, c, f) {
                return function() {
                    function g(a) {
                        var b = c.groupSelect(a, c.dataMapper.array),
                            d = "kumoclipup-" + e(),
                            f = "kumoclipdown-" + e();
        ...
        41: [function(a, b, c) {
            ...
            b.exports = function(b) {
                var c = a("../scale")(b),
                    e = a("../accessor")(),
                    f = a("./plot")(b.svg.line, b.select),
                    g = a("./plotmixin")(b.scale.linear, b.functor, c.financetime, f.barWidth),
                    h = a("./line"),
                    i = a("./axisannotation")(b.svg.axis, e.value, f, g),
                    j = a("../svg")(b);
                return {
        ...
        45: [function(a, b, c) {
            ...
            b.exports = function(a, b) {
                ...
                function f() {
                    ...
                    var b = D3.d3.svg.area().interpolate("monotone");
                    ...
                    annotation: {
                        append: function(a, c, d, e, f) {
                            var g = arguments.length,
                                h = a.append("g").attr("class", "axisannotation " + d).selectAll("g").data(function(a) {
            ...
            b.exports = function(a, b, c, e, f, g, h) {
                ...
                function j(e, f, h, i, j) {
                    var k = a().origin(function(a) {
                        ...
                        var k = i.invert(b().y),
                            l = c(this.parentNode.parentNode),
                            m = l.selectAll(".axisannotation.y > g");
        ...
        51: [function(a, b, c) {
            ...
            b.exports = function(a, b, c, d, e, f, g, h) {
                return function() {
                    function i(b) {
                        var d = f.groupSelect(b, f.dataMapper.array),
                            e = l(b.datum());
                        f.appendPathsGroupBy(d.entry, n.accessor, "tradearrow", e), d.entry.append("path").attr("class", "highlight").style({
                            "pointer-events": "none"
                        }), d.selection.selectAll("path.tradearrow").on("mouseenter", function(b) {
                            var d = k(b, c(this)[0]);
        ...
        52: [function(a, b, c) {
            ...
            b.exports = function(a, b, c, e, f, g, h) {
                function i() {
                    function a(b) {
                        var d = g.groupSelect(b, g.dataMapper.unity),
                            e = d.entry.append("g").attr("class", "trendline");
                        e.append("path").attr("class", "body"), e.append("circle").attr({
                            "class": "start",
                            r: 1
                        }), e.append("circle").attr({
                            "class": "end",
                            r: 1
                        });
            ...
            b.exports = function(a, b, c, d, e, f) {
                function g(b, m, q, r, s, t, u, v) {
                    ...
                    function A(a, d, e) {
                        ...
                        var f = a[a.length - 1] - a[0],
                            g = 1 > f / n,
                            h = g ? b.intraday : b.daily,
                            j = g ? p : o,
                            k = Math.min(Math.round(i(a, d) * e), e),
                            l = f / k,
                            q = c(j, l);
                ...
                var n = 864e5,
                    o = [n, 6048e5, 2592e6, 7776e6, 31536e6],
                    p = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5],
                    q = b.format("%b %e"),
                    r = b.format.multi([
                        ["%b %Y", function(a) {
                            return a.getMonth()
                    ...
                    x = [b.second, 1, b.format.utc.multi([
                        [":%S", function(a) {
                            return a.getUTCSeconds()
                        }],
                        ["%I:%M", function(a) {
        ...
        56: [function(a, b, c) {
            ...
            b.exports = function(b) {
                var c = a("./zoomable")(),
                    d = a("../util")(),
                    h = a("../accessor")(),
                    i = a("./financetime")(b.scale.linear, b.time, b.bisect, d.rebindCallback, f, c);
                return {
                    financetime: i,
                    analysis: {
        ...
        60: [function(a, b, c) {
            "use strict";
            var d;
            if ("undefined" != typeof window) d = window.D3.d3;
            else {
                if ("object" != typeof b) throw "Unsupported runtime environment: Could not find D3.d3. Ensure defined globally on window, or available as dependency.";
                d = a("D3.d3")
            }
            b.exports = function(b) {
                return {
